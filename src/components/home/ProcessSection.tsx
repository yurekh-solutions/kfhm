      ...
      <div className="container max-w-7xl mx-auto relative px-4">
        <div className="mb-16 space-y-4 animate-fade-in text-center">
          ...
          <h2 className="text-5xl md:text-6xl font-black text-gray-900 mt-4">
            Get Amazing Cleaning In <span className="bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent">4 Simple Steps</span>
          </h2>
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="font-black text-xl text-gray-900 mb-3 group-hover:text-red-700 transition-colors">{step.title}</h3>
                    <p className="text-gray-700 text-sm leading-relaxed group-hover:text-gray-900 transition-colors">{step.description}</p>
                  </div>
                </div>
              </div>
            ))}
              ...
              >
                ...
                <div className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 text-left border-2 border-white/40 shadow-xl hover:shadow-2xl hover:shadow-red-200/50 transition-all duration-300 hover:-translate-y-3 h-full pt-16 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="font-black text-lg text-gray-900 mb-2 group-hover:text-red-700 transition-colors">{step.title}</h3>
                    <p className="text-gray-700 text-sm leading-relaxed group-hover:text-gray-900 transition-colors">{step.description}</p>
                  </div>
                </div>
              </div>
