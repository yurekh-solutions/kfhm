    ...
    <section className="py-12 md:py-24 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto relative px-4 md:px-6">
       ...
       Testimonials
          ...
          <h6 className="text-3xl md:text-5xl lg:text-6xl  leading-relaxed  font-bold font-[600] font-black text-gray-900 mt-2 md:mt-4 leading-tight">
            See  our <span className="bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">Happy Customers</span>  
          </h6>
        </div>
